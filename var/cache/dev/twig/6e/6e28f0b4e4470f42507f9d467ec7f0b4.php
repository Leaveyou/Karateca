...
class __TwigTemplate_bbbd15cb2a63b75158ef8cc35bad1b7e extends Template
{
    private $source;
    private $macros = [];
...
{% block panel %}
    ...
    {% endfor %}
{% endblock %}
", "@WebProfiler/Collector/validator.html.twig", "/var/www/Karateca/vendor/symfony/web-profiler-bundle/Resources/views/Collector/validator.html.twig");
    }
}
